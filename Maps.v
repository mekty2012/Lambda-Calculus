...
Theorem t_update_neq : forall (A : Type) (m : total_map A) x1 x2 v,
    ...
    (x1 !-> v ; m) x2 = m x2.
Proof.
  intros. unfold t_update. rewrite -> false_eqb_string. reflexivity. apply H. Qed.
  (* FILL IN HERE *) 
(** [] *)
...
(** For the final two
 lemmas about total maps, it's convenient to use
...
Proof.
  ...
  - unfold t_update. apply eqb_string_false_iff in n. rewrite -> n. reflexivity.
  Qed.
  (* FILL IN HERE *) 
(** [] *)
...
Proof.
  ...
  - unfold t_update. rewrite -> e. rewrite <- eqb_string_refl. 
    ...
    + reflexivity.
  - unfold t_update. apply eqb_string_false_iff in n. rewrite -> n.
    reflexivity.
  Qed.
  (* FILL IN HERE *) 
(** [] *)
